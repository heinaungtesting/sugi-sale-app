...
describe('pet-records v2 asset roll-out', () => {
  it('ships only the remaining v2 image assets used by the app', () => {
  ...
  it('does not point nav-pet or metric-mascot at the old broken assets', () => {
    ...
    const banned = ['/cute/dog-icon.webp', '/cute/cat-icon.webp', '/cute/search-cat.webp',
                    '/cute/stat-dog.webp', '/cute/stat-cat.webp', '/cute/v1-icon-tan-dog.webp',
                    '/cute/v1-icon-gray-cat.webp', '/cute/v2-playtime-bone-dog.webp',
                    '/cute/v2-head-dog-thumbsup.webp', '/cute/v2-paws-light.webp',
                    '/cute/v2-paws-brown.webp', '/cute/v2-flowers.webp', '/cute/v2-treats.webp'];
